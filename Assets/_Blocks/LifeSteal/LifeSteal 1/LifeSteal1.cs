...
public class LifeSteal1 : BlockAbility
{
    ...
    private void Start()
    {
        ...
        descriptionTemplate = "Deals {0} + Player’s Attack Power damage to the nearest enemy ({1} + Player’s Attack Power on a critical hit), and restores HP equal to {2} of the damage dealt by this block.";
    }
    ...
    {
        description = string.Format(descriptionTemplate, attackDamage, criticalHitDamage, lifestealRatio);
    }
