...
public class EtcBlock14 : BlockAbility
{
    ...
    public override void Upgrade()
    {
        ...
        Description = string.Format("Deals {0} damage + Player ({1} on crit) and gains {2} defense.", AttackDamage, CriticalHitDamage, Defense); // Update description
    }
